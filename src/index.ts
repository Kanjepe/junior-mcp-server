...
// ============================================================================
// 🧑‍💻 JUNIOR — Your OpenAI-powered intern inside Claude Code
//
// "Hey Junior, go figure this out..."
// "Junior, review this code for me"
// "Junior, think hard about this architecture problem"
// ============================================================================
...
async function callJunior(
  ...
  if (!config.apiKey) {
    throw new Error(
      "OPENAI_API_KEY not set. Junior can't work without credentials!\n" +
  ...
  // Extract the response text and thinking summary
  let text = "";
  let thinkingSummary = "";
...
// --------------------------------------------------------------------------
// Format Junior's response nicely
// --------------------------------------------------------------------------
...
// === Tool 1: ask_junior ===
// The main workhorse — ask Junior anything
...
async function main(): Promise<void> {
  ...
  console.error("🧑‍💻 Junior is ready! Model:", config.model, "| Default reasoning:", config.reasoningEffort);
}

main().catch((error: unknown) => {
  console.error("Junior failed to start:", error);
  process.exit(1);
});